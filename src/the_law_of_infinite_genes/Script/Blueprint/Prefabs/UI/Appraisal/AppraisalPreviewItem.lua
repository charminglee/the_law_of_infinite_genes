---@class AppraisalPreviewItem_C:UUserWidget
...
--Edit Below--
local AppraisalPreviewItem = { bInitDoOnce = false, DefineID=nil}

function AppraisalPreviewItem:Construct()
	self:LuaInit()
end

function AppraisalPreviewItem:LuaInit()
...
--- @param DefineID ItemDefineID
function AppraisalPreviewItem:SetDefineID(DefineID)
...
function AppraisalPreviewItem:AsyncSetTexture(path, UI)
