...
ACHVManager = ACHVManager or
{
    ...
    Config = {
        ...
        UnlockConditions = {
            ...
            {'赛季等级达到10级\n累计击杀普通僵尸 500 只', '赛季等级达到20级\n累计击杀精英怪 150 只', '赛季等级达到30级\n单局内击杀100普通僵尸，且全程生命值从未低于50%', '赛季等级达到40级\n单局内击杀30只精英怪，且全程生命值从未低于50%', '赛季等级达到50级\n累积击杀50次boss', '赛季等级达到100级\n无伤击败boss一次'}
        };
        CollectEffects = {
        ...
        WearEffects = {
            ...
            {'对普通僵尸伤害 +5%', '对精英僵尸伤害 +5%', '对普通僵尸伤害 +8%\n受到普通僵尸伤害 -3%', '对精英僵尸伤害 +8%\n受到精英僵尸伤害 -3%', '全伤+10%\n伤害-5%\n暴击率+3%', '全伤+15%\n伤害-10%\n暴击率+5%\n第一次死亡时候无敌3秒，并且回复30%血量'}
        };
