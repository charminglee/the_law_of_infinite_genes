...
function DegreeChoiceItem:SetState(bSelected, bLocked, bVisible)
    ...
    self.Image_Selected:SetVisibility(bSelected and not bLocked and ESlateVisibility.SelfHitTestInvisible or ESlateVisibility.Collapsed)
    self.Image_NoSelected:SetVisibility(not bSelected and not bLocked and ESlateVisibility.SelfHitTestInvisible or ESlateVisibility.Collapsed)
