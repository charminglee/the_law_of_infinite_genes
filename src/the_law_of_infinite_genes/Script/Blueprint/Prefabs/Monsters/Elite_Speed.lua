...
-- function Elite_Speed:ReceiveEndPlay()
--     Elite_Speed.SuperClass.ReceiveEndPlay(self) 
-- end

-- function Elite_Speed:GetReplicatedProperties()
--     return
-- end
...
-- function Elite_Speed:PreTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
-- ---@param DamageCauser AActor 伤害来源
-- ---@param DamageContext FGameMagnitudeContext  伤害上下文
-- function Elite_Speed:PostTakeDamageEvent(Damage, EventInstigator, DamageCauser, DamageContext)
...
-- function Elite_Speed:PreOverrideDamage(Damage, EventInstigator, DamageCauser, DamageContext)
--     return Damage
-- end
...
-- ---@param DamageContext FGameMagnitudeContext  伤害上下文
-- ---@return float 修改后的伤害值
-- function Elite_Speed:PostOverrideDamage(Damage, EventInstigator, DamageCauser, DamageContext)
--     return Damage
-- end
...
-- function Elite_Speed:OnEnterTagState_BP(DynamicState)
...
-- function Elite_Speed:OnLeaveTagState_BP(DynamicState)
--     local Tag = BlueprintGameplayTagLibrary.GetTagName(DynamicState)
...
-- function Elite_Speed:OnInterruptTagState_BP(DynamicState)
--     local Tag = BlueprintGameplayTagLibrary.GetTagName(DynamicState)
...
-- function Elite_Speed:OnBehaviorNotify_BP(NotifyMsg)
...
-- function Elite_Speed:OnTargetChange_BP(NewTarget, OldTarget)
