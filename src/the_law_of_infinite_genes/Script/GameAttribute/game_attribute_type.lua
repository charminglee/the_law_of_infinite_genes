...
UGCCustomGameAttributeType = { 
	...
	--Character [金币数量-CoinCount],
	UGCAttributeGroup_Character_CoinCount = 'CoinCount',
	--Character [起源币数量-QYCoinCount],
	UGCAttributeGroup_Character_QYCoinCount = 'QYCoinCount',
	--Character [普通怪物击杀数量-NormalMonsterKillCount],
	UGCAttributeGroup_Character_NormalMonsterKillCount = 'NormalMonsterKillCount',
	--Character [精英怪物击杀数量-EliteMonsterKillCount],
	UGCAttributeGroup_Character_EliteMonsterKillCount = 'EliteMonsterKillCount',
	--Character [Boss击杀数量-BossKillCount],
	UGCAttributeGroup_Character_BossKillCount = 'BossKillCount',
	--Character [全程生命值从未低于50%单局内普通怪物击杀数量-NormalMonsterKillCountHealthAboveHalf],
	UGCAttributeGroup_Character_NormalMonsterKillCountHealthAboveHalf = 'NormalMonsterKillCountHealthAboveHalf',
	--Character [全程生命值从未低于50%单局内精英怪物击杀数量-EliteMonsterKillCountHealthAboveHalf],
	UGCAttributeGroup_Character_EliteMonsterKillCountHealthAboveHalf = 'EliteMonsterKillCountHealthAboveHalf',
	--Character [伤害减免（固定值）-DamageDecreace],
	UGCAttributeGroup_Character_DamageDecreace = 'DamageDecreace',
	--Character [伤害减免（百分比）-DamageDecreacePct],
...
UGCCustomGameAttributeTypeCommentMap = { 
	...
	['CoinCount'] = 'Character [金币数量-CoinCount]', 
	['QYCoinCount'] = 'Character [起源币数量-QYCoinCount]', 
	['NormalMonsterKillCount'] = 'Character [普通怪物击杀数量-NormalMonsterKillCount]', 
	['EliteMonsterKillCount'] = 'Character [精英怪物击杀数量-EliteMonsterKillCount]', 
	['BossKillCount'] = 'Character [Boss击杀数量-BossKillCount]', 
	['NormalMonsterKillCountHealthAboveHalf'] = 'Character [全程生命值从未低于50%单局内普通怪物击杀数量-NormalMonsterKillCountHealthAboveHalf]', 
	['EliteMonsterKillCountHealthAboveHalf'] = 'Character [全程生命值从未低于50%单局内精英怪物击杀数量-EliteMonsterKillCountHealthAboveHalf]', 
	['DamageDecreace'] = 'Character [伤害减免（固定值）-DamageDecreace]', 
	['DamageDecreacePct'] = 'Character [伤害减免（百分比）-DamageDecreacePct]', 
}; 
