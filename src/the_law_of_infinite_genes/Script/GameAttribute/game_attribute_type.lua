...
UGCCustomGameAttributeType = { 
	--Character [防御穿透百分比-BreakDefencePct],
	UGCAttributeGroup_Character_BreakDefencePct = 'BreakDefencePct',
	--Character [暴击几率-CritChance],
	UGCAttributeGroup_Character_CritChance = 'CritChance',
	--Character [暴击伤害-CritDamagePct],
	UGCAttributeGroup_Character_CritDamagePct = 'CritDamagePct',
	--Character [防御力-Defence],
	UGCAttributeGroup_Character_Defence = 'Defence',
	--Character [防御力百分比-DefensePct],
	UGCAttributeGroup_Character_DefensePct = 'DefensePct',
	--Character [吸血倍率-HealthStealPct],
	UGCAttributeGroup_Character_HealthStealPct = 'HealthStealPct',
	--Character [反伤倍率-CounterAttackPct],
	UGCAttributeGroup_Character_CounterAttackPct = 'CounterAttackPct',
	--Character [等级-Level],
	UGCAttributeGroup_Character_Level = 'Level',
	--Character [通用伤害加成-DamagePct],
	UGCAttributeGroup_Character_DamagePct = 'DamagePct',
	--Character [普通怪伤害加成-NormalMonsterDamagePct],
	UGCAttributeGroup_Character_NormalMonsterDamagePct = 'NormalMonsterDamagePct',
	--Character [精英怪伤害加成-EliteMonsterDamagePct],
	UGCAttributeGroup_Character_EliteMonsterDamagePct = 'EliteMonsterDamagePct',
	--Character [Boss伤害加成-BossDamagePct],
	UGCAttributeGroup_Character_BossDamagePct = 'BossDamagePct',
	--Character [赛季等级-SeasonLevel],
	UGCAttributeGroup_Character_SeasonLevel = 'SeasonLevel',
	--Character [伤害减免-DamageDecreace],
	UGCAttributeGroup_Character_DamageDecreace = 'DamageDecreace',
	--Character [伤害减免百分比-DamageDecreacePct],
	UGCAttributeGroup_Character_DamageDecreacePct = 'DamageDecreacePct',
	--Character [攻击力-AttackPower],
	UGCAttributeGroup_Character_AttackPower = 'AttackPower',
	--Character [攻击力百分比-AttackPowerPct],
	UGCAttributeGroup_Character_AttackPowerPct = 'AttackPowerPct',
...
UGCCustomGameAttributeTypeCommentMap = { 
	['BreakDefencePct'] = 'Character [防御穿透百分比-BreakDefencePct]', 
	['CritChance'] = 'Character [暴击几率-CritChance]', 
	['CritDamagePct'] = 'Character [暴击伤害-CritDamagePct]', 
	['Defence'] = 'Character [防御力-Defence]', 
	['DefensePct'] = 'Character [防御力百分比-DefensePct]', 
	['HealthStealPct'] = 'Character [吸血倍率-HealthStealPct]', 
	['CounterAttackPct'] = 'Character [反伤倍率-CounterAttackPct]', 
	['Level'] = 'Character [等级-Level]', 
	['DamagePct'] = 'Character [通用伤害加成-DamagePct]', 
	['NormalMonsterDamagePct'] = 'Character [普通怪伤害加成-NormalMonsterDamagePct]', 
	['EliteMonsterDamagePct'] = 'Character [精英怪伤害加成-EliteMonsterDamagePct]', 
	['BossDamagePct'] = 'Character [Boss伤害加成-BossDamagePct]', 
	['SeasonLevel'] = 'Character [赛季等级-SeasonLevel]', 
	['DamageDecreace'] = 'Character [伤害减免-DamageDecreace]', 
	['DamageDecreacePct'] = 'Character [伤害减免百分比-DamageDecreacePct]', 
	['AttackPower'] = 'Character [攻击力-AttackPower]', 
	['AttackPowerPct'] = 'Character [攻击力百分比-AttackPowerPct]', 
